...
# 1. Start off from Python 3.6 on Alpine Linux 3.7:
...
# NOTE: When adding/removing packages on this step, make sure you replicate the
# changes on the "deployable" stage.
